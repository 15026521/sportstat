...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      { icon: 'trending_up', text: '我的数据分析', link: '/myDatas' },
      { icon: 'subscriptions', text: '订阅数据报告', link: '/subscriptDatas' },
      { icon: 'featured_play_list', text: '我关注的用户' },
      { icon: 'watch_later', text: '原始数据工厂' }
    ],
    items2: [
