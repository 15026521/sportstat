      ...
      <div id="login">
        ...
        <span>
          ...
          <form action="post">
            ...
            />
            <input type="button" value="Sign in" class="btn" v-on:click="signin" id="btn" />
          </form>
...
var registerBtn = document.getElementsByName("Sign in");
//自动居中title
...
export default class Login extends Vue{
    ...
    //     //回调函数
    //     // submit(callback) {
    //     //     if (passwd.textContent == con_pass.textContent) {
    //     //     let request = new XMLHttpRequest()
    //     //     let url = ""
    //     //     request.open("post", url, true)
    //     //     let data = new FormData()
    //     //     data.append("user", user.textContent)
    //     //     data.append("passwd", passwd.textContent)
    ...
    //             onoff = !onoff
    //         // } else {
    //         //     if (!/^[A-Za-z0-9]+$/.test(user.textContent))
    //         //         hit.innerHTML = "账号只能为英文和数字"
    //         //     else if (user.textContent.length < 6)
    //         //         hit.innerHTML = "账号长度必须大于6位"
    //         //     else if (passwd.textContent.length < 6)
    //         //         hit.innerHTML = "密码长度必须大于6位"
    //         //     else if (passwd.textContent != con_pass.textContent)
